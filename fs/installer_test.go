...
var filesToInstall = map[string]string{
	...
	"https://github.com/go-iris2/iris2/errors/archive/master.zip": testInstalledDir + "go-errors-master",
	"https://github.com/go-iris2/iris2/fs/archive/master.zip":     testInstalledDir + "go-fs-master",
