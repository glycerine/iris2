...
func TestContextDoNextStop(t *testing.T) {
	var context iris2.Context
	ok := false
	afterStop := false
	context.Middleware = iris2.Middleware{iris2.HandlerFunc(func(*iris2.Context) {
		ok = true
	}), iris2.HandlerFunc(func(*iris2.Context) {
		ok = true
	}), iris2.HandlerFunc(func(*iris2.Context) {
...
func TestContextHostString(t *testing.T) {
	app := iris2.New(iris2.Configuration{VHost: "0.0.0.0:8080"})
	app.Adapt(newTestNativeRouter())
	...
	app.Get("/wrong", func(ctx *iris2.Context) {
...
func TestContextVirtualHostName(t *testing.T) {
	...
	app := iris2.New(iris2.Configuration{VHost: vhost + ":8080"})
	app.Adapt(newTestNativeRouter())
...
func TestContextFormValueString(t *testing.T) {
	...
	k = "postkey"
	v = "postvalue"
	app.Post("/", func(ctx *iris2.Context) {
...
func TestContextSubdomain(t *testing.T) {
	...
	app.Party("mysubdomain.").Get("/mypath", func(ctx *iris2.Context) {
...
func TestLimitRequestBodySizeMiddleware(t *testing.T) {
	...
	app.Use(iris2.LimitRequestBodySize(maxBodySize))
	...
	// app.UseGlobal(iris2.LimitRequestBodySize(int64(maxBodySize)))
